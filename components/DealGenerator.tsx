...
export const DealGenerator: React.FC = () => {
    ...
    // Inputs
    const [tagline, setTagline] = useState("10% off your first order if you download the App");
    const [customBgPrompt, setCustomBgPrompt] = useState('A family dinner');
                ...
                const companyPrompts = ratios.map(async (ratio) => {
                    ...
                    const brandingInstruction = `
                        **Branding Guidelines:**
                        ...
                        - Font Preference: YOU MUST STRICTLY FOLLOW THIS FONT: ${company.font || "Standard commercial font"}
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 h-fit lg:col-span-1">
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            placeholder="e.g. A family dinner"
                        />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            className="w-full rounded-lg border-2 border-gray-300 px-4 py-3 text-sm focus:border-blue-900 focus:outline-none h-24 resize-none"
                            placeholder="e.g. 10% off your first order if you download the App"
                        />
                    </div>
