...
import { Upload, Save, CheckCircle, AlertCircle, PlusCircle, ArrowLeft, Edit2, Trash2, Building2 } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto p-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <div className="flex justify-end">
                    <button onClick={saveCompany} disabled={status === 'saving'} className="flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50">
                        <Save size={18} />
                        Save Company
                    </button>
                </div>
